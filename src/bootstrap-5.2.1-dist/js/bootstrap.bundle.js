...
(function (global, factory) {
  ...
  function getWindowScrollBarX(element) {
    ...
    // anyway.
    // Browsers where the left scrollbar doesn't cause an issue report <code>0<code> for
  ...
  // of the <code><html><code> and <code><body><code> rect bounds if horizontally scrollable
    ...
    return function createPopper(reference, popper, options) {
      ...
      var instance = {
        ...
        setOptions: function setOptions(setOptionsAction) {
          ...
          }; // Orders the modifiers based on their dependencies and <code>phase<code>
          // properties
        ...
        // logic.
        // For high frequency updates (e.g. <code>resize<code> and <code>scroll<code> events), always
        ...
        forceUpdate: function forceUpdate() {
          ...
          var _state$elements = state.elements,
              ...
              popper = _state$elements.popper; // Don't proceed if <code>reference<code> or <code>popper<code> are not valid elements
          // anymore
          ...
          // most common use case for this is the <code>flip<code> modifier changing the
          // placement, which then needs to re-run all the modifiers, because the
          // logic was previously ran for the previous placement and is therefore
          // stale/incorrect

          state.reset = false;
          state.placement = state.options.placement; // On each update cycle, the <code>modifiersData<code> property for each modifier
          // is filled with the initial data specified by the modifier. This means
          // it doesn't persist and is fresh on each update.
          // To ensure persistent data, use <code>${name}#persistent<code>
